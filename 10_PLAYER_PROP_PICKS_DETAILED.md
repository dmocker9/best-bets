# 🎯 10 Player Prop Picks - COMPREHENSIVE DETAILED ANALYSIS

## Overview
This document provides **DETAILED** analysis for each of the 10 selected player prop predictions, including:
- **Player Statistical Breakdown** (season averages, consistency metrics, efficiency)
- **Defensive Matchup Analysis** (opponent rankings, yards allowed, key defensive stats)
- **Game Script Analysis** (Vegas totals, spreads, expected game flow)
- **Key Injuries** (impact on player production and team game plan)
- **Model Prediction Reasoning** (how all factors combine)

---

## 🏈 QUARTERBACKS (3 Picks)

---

### 1. **Patrick Mahomes - Passing Yards O/U 260.5** @ Denver Broncos

#### 📊 Player Statistical Breakdown
...
**Performance vs Line:**
- Season average (261.0) = Line (260.5) → **+0.5 yards edge**
- This is essentially a coin flip based on season average alone

---

#### 🛡️ Defensive Matchup Analysis
...
**Game Script Impact:**
- **Neutral to slightly negative** for Mahomes' pass yards
- If Chiefs lead, they'll run clock (fewer pass attempts)
- If close game, balanced attack (moderate pass volume)
...
**Kansas City Chiefs:**
- **Isiah Pacheco (RB) - OUT** → May force more passing if run game struggles
- **Impact:** Slight positive for Mahomes (more pass attempts if run game ineffective)

**Denver Broncos:**
- **Patrick Surtain II (CB) - OUT** → **MAJOR IMPACT** - Denver's best cornerback out
- **Alex Singleton (LB) - OUT** → May affect coverage in middle of field
- **Jonah Elliss (OLB) - OUT** → May reduce pass rush slightly
- **Impact:** **Positive for Mahomes** - Denver's elite secondary is weakened

**Net Injury Impact:**
- **+2 to +4 yards** for Mahomes (Surtain being out is significant)
...
### 2. **Dak Prescott - Passing TDs O/U 1.5** vs Las Vegas Raiders
...
**Game Script Impact:**
- **Positive for Prescott's TD production**
- Cowboys favored = more scoring opportunities
- High total = more touchdowns expected
- Home game = better execution in red zone
...
**Las Vegas Raiders:**
- No major defensive injuries that would significantly impact pass defense
- **Impact:** Neutral

**Net Injury Impact:**
- **Neutral** - no significant injuries affecting this prop
...
### 3. **Bo Nix - Pass Completions O/U 21.5** @ Kansas City Chiefs
...
**Game Script Impact:**
- **Slightly positive** for Nix's completions
- Underdog status = more pass attempts if trailing
- Road game = more difficult (negative factor)
...
**Denver Broncos:**
- **J.K. Dobbins (RB) - OUT** → **MAJOR IMPACT**
  - Broncos lose their primary RB (77.2 yds/game, 15.3 att/game)
  - **Impact:** Broncos will likely pass MORE (positive for Nix completions)
  - Less effective run game = more pass attempts needed
- **Trent Sherfield (WR) - OUT** → Slight negative (one less target)
- **Nate Adkins (TE) - OUT** → Minimal impact

**Kansas City Chiefs:**
- **Isiah Pacheco (RB) - OUT** → May affect game script slightly
- **Impact:** Neutral for Nix

**Net Injury Impact:**
- **+1 to +2 completions** for Nix (Dobbins out forces more passing)
...
## 🏃 RUNNING BACKS (3 Picks)

---

### 4. **Derrick Henry - Rushing Yards O/U 76.5** @ Cleveland Browns
...
**Game Script Impact:**
- **Positive for Henry's rush attempts** (favored = more runs)
- **Negative for efficiency** (Browns' elite defense will limit YPA)
- If Ravens lead big, Henry gets more carries but against tough defense
...
**Baltimore Ravens:**
- **Lamar Jackson (QB) - OUT** → **MAJOR IMPACT**
  - Ravens lose their dual-threat QB
  - **Impact:** Ravens will rely MORE on run game (positive for Henry)
  - Less effective passing = more rushing attempts
  - Backup QB = more conservative game plan
- **Justice Hill (RB) - OUT** → Positive (less competition for carries)
- **Rashod Bateman (WR) - OUT** → Slight positive (more run-heavy offense)
- **Marlon Humphrey (CB) - OUT** → Defensive impact (may need to score more)

**Cleveland Browns:**
- **Alex Wright (DE) - OUT** → Slight positive for Henry (one less pass rusher)
- **Impact:** Minimal - Browns' run defense is still elite

**Net Injury Impact:**
- **+3 to +5 rush attempts** for Henry (Lamar out = more runs)
- **-0.5 to -1.0 YPA** (backup QB = less threat, defense focuses on run)
- **Net:** More attempts but lower efficiency = similar total yards
...
### 5. **RJ Harvey - Rushing Yards O/U 55.5** @ Kansas City Chiefs
...
**Game Script Impact:**
- **Slightly negative** for Harvey's rush yards
- Underdog status = may pass more if trailing
- Road game = more difficult
...
**Denver Broncos:**
- **J.K. Dobbins (RB1) - OUT** → **MASSIVE IMPACT**
...
**Kansas City Chiefs:**
- **Isiah Pacheco (RB) - OUT** → Minimal impact for Harvey

**Net Injury Impact:**
- **+30.7 yards** for Harvey (massive boost from Dobbins being out)
...
### 6. **Chase Brown - Rush Attempts O/U 14.5** @ Pittsburgh Steelers
...
**Game Script Impact:**
- **Negative for Brown's rush attempts**
- Underdog by 5.5 = likely to trail = abandon run game
- Lower total = less scoring = fewer opportunities
...
**Cincinnati Bengals:**
- **Joe Flacco (QB) - OUT** → **MAJOR IMPACT**
  - Backup QB starting
  - **Impact:** Bengals may run MORE (positive for Brown)
  - Less effective passing = more rushing attempts
  - Conservative game plan with backup QB
- **Samaje Perine (RB) - OUT** → Positive (less competition)
- **Trey Hendrickson (DE) - OUT** → Defensive impact (may need to score more)

**Pittsburgh Steelers:**
- **T.J. Watt (LB) - OUT** → **MAJOR IMPACT**
  - Steelers lose their best defensive player
  - **Impact:** Slight positive for Brown (easier to run)
  - But Steelers' run defense is still solid without Watt
- **Alex Highsmith (LB) - OUT** → Slight positive
- **Cameron Heyward (DT) - OUT** → Slight positive
- **Multiple defensive injuries** → Slight positive for Brown

**Net Injury Impact:**
- **+1 to +2 rush attempts** for Brown (Flacco out = more runs, Steelers injuries help)
...
## 🏈 WIDE RECEIVERS (3 Picks)

---

### 7. **Justin Jefferson - Receiving Yards O/U 71.5** vs Chicago Bears
...
**Game Script Impact:**
- **Neutral to slightly positive** for Jefferson
- Favored at home = more scoring opportunities
- Jefferson is always the focal point regardless of game script
...
**Minnesota Vikings:**
- **Jonathan Greenard (OLB) - OUT** → Defensive impact (may need to score more)
- **Impact:** Neutral for Jefferson

**Chicago Bears:**
- **Tyrique Stevenson (DB) - OUT** → **POSITIVE IMPACT**
  - Bears lose a key defensive back
  - **Impact:** +2 to +3 yards for Jefferson (easier matchup)
- **Jaquan Brisker (DB) - OUT** → **POSITIVE IMPACT**
  - Bears lose another defensive back
  - **Impact:** +1 to +2 yards for Jefferson
- **Kevin Byard (DB) - OUT** → **POSITIVE IMPACT**
  - Bears lose experienced safety
  - **Impact:** +1 to +2 yards for Jefferson
- **D.J. Moore (WR) - OUT** → Offensive impact (Bears may pass less)
- **Rome Odunze (WR) - OUT** → Offensive impact
- **Jahdae Walker (WR) - OUT** → Offensive impact
- **Multiple defensive back injuries** → **Significant positive for Jefferson**

**Net Injury Impact:**
- **+4 to +6 yards** for Jefferson (multiple Bears DBs out)
...
### 8. **Amon-Ra St. Brown - Receiving Yards O/U 75.5** @ Philadelphia Eagles
...
**Game Script Impact:**
- **Slightly positive** for St. Brown (may trail, pass more)
- But Eagles' elite defense will limit production regardless
...
**Detroit Lions:**
- **Sam LaPorta (TE) - OUT** → **POSITIVE IMPACT**
  - Lions lose their primary TE
  - **Impact:** +2 to +3 yards for St. Brown (more targets)
  - Targets redistribute to WRs
- **Brock Wright (TE) - OUT** → Slight positive (more targets for WRs)
- **Sione Vaki (RB) - OUT** → Minimal impact
- **Terrion Arnold (CB) - OUT** → Defensive impact
- **Aidan Hutchinson (DE) - OUT** → Defensive impact
- **Kerby Joseph (S) - OUT** → Defensive impact
- **Penei Sewell (T) - OUT** → Offensive line impact (may affect passing)

**Philadelphia Eagles:**
- No major defensive injuries reported
- **Impact:** Neutral (Eagles' elite defense intact)

**Net Injury Impact:**
- **+2 to +3 yards** for St. Brown (LaPorta out = more targets)
- But Eagles' elite defense will still limit production
...
### 9. **Jameson Williams - Receiving Yards O/U 48.5** @ Philadelphia Eagles
...
**Game Script Impact:**
- **Slightly positive** for Williams (may trail, pass more)
- But Eagles' elite defense will limit production regardless
- Williams is WR2/WR3, so targets may go to St. Brown first
...
- **Sam LaPorta (TE) - OUT** → **POSITIVE IMPACT**
  - Lions lose their primary TE
  - **Impact:** +1 to +2 yards for Williams (more targets)
  - Targets redistribute to WRs, but St. Brown gets most
- **Brock Wright (TE) - OUT** → Slight positive
- **Multiple offensive injuries** → May affect passing game efficiency
...
**Net Injury Impact:**
- **+1 to +2 yards** for Williams (LaPorta out = more targets)
- But limited impact since he's WR2/WR3
...
### 10. **Travis Kelce - Receiving Yards O/U 44.5** @ Denver Broncos
...
**Game Script Impact:**
- **Neutral to slightly positive** for Kelce
- Kelce is always targeted regardless of game script
- Mahomes' favorite target = consistent production
...
**Kansas City Chiefs:**
- **Isiah Pacheco (RB) - OUT** → **POSITIVE IMPACT**
  - Chiefs lose their primary RB
  - **Impact:** +1 to +2 yards for Kelce (more targets if run game struggles)
  - May need to pass more

**Denver Broncos:**
- **Nate Adkins (TE) - OUT** → Minimal impact (Broncos' TE, not relevant)
- **Patrick Surtain II (CB) - OUT** → **POSITIVE IMPACT**
  - Broncos lose their best cornerback
  - **Impact:** +1 to +2 yards for Kelce (easier coverage overall)
- **Alex Singleton (LB) - OUT** → **POSITIVE IMPACT**
  - Broncos lose a linebacker
  - **Impact:** +1 to +2 yards for Kelce (easier coverage in middle)
- **Jonah Elliss (OLB) - OUT** → Slight positive (less pass rush)

**Net Injury Impact:**
- **+3 to +5 yards** for Kelce (multiple Broncos defensive injuries)
...
### By Recommendation:
- **OVER:** 4 picks
  - Dak Prescott TDs (High confidence)
  - Bo Nix Completions (Medium confidence)
  - Justin Jefferson Yards (Medium-High confidence)
  - Travis Kelce Yards (Very High confidence - BEST PLAY)

- **UNDER:** 6 picks
  - Patrick Mahomes Yards (Medium-High confidence)
  - Derrick Henry Yards (High confidence)
  - RJ Harvey Yards (Medium-High confidence)
  - Chase Brown Attempts (High confidence)
  - Amon-Ra St. Brown Yards (Medium-High confidence)
  - Jameson Williams Yards (Low-Medium confidence - close)

### Best Value Picks (Top 3):
1. **Travis Kelce OVER 44.5** - Highest confidence, biggest edge (+18.5 to +22.5 yards)
2. **Dak Prescott OVER 1.5 TDs** - Strong season average, favorable matchup
3. **Derrick Henry UNDER 76.5** - Elite defense limits elite RB

### Key Injury Impacts:
- **J.K. Dobbins OUT** → +30.7 yards for RJ Harvey (still UNDER)
- **Lamar Jackson OUT** → More rush attempts for Derrick Henry (but lower efficiency)
- **Multiple Bears DBs OUT** → +4 to +6 yards for Justin Jefferson
- **Multiple Broncos defensive injuries** → +3 to +5 yards for Travis Kelce
