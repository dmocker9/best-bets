...
import { getBestBetsFromDatabase } from '@/lib/predictGames';
...
export async function GET(request: Request) {
  try {
    ...
    const predictions = await getBestBetsFromDatabase(limit, week, season);
    ...
    const response: BestBetsResponse = {
      ...
      message: predictions.length > 0 
        ...
        : 'No predictions available. Run /api/generate-predictions first.',
